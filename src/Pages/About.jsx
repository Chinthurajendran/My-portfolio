        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              A passionate full-stack web developer skilled in React,
              JavaScript, Django, FastAPI, and Docker. I build responsive
              websites and scalable APIs, and I enjoy solving real-world
              problems with clean, efficient code.
            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/file/d/1rNVTN2YIb4z1Ejrt-XlvY2FsA7ofVCsy/view?usp=drive_link"
